...
| ##### 请求体（Request Body） |
| **model** `*string*` **（必选）** 模型名称。模型列表与价格详见[模型价格](https://help.aliyun.com/zh/model-studio/models#577af209dc0rc)。 示例值：wan2.7-t2v。 |
...
-   SDK代码支持wan2.6及早期系列模型，**暂不支持wan2.7模型**。
