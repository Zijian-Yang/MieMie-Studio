...
BACKUP_FILE="validation-artifacts/r102-server-final-exit-sequence-health-engine-cache-20260619/apply-final-json-exit-policy/compose.env.before-final-json-exit.r102-server-final-exit-sequence-health-engine-cache-20260619-apply-final-json-exit-policy.bak"
