...
- Run ID: `r59-connectivity-after-direct-rule-20260617`
- State: `blocked`
...
public_health | failed | curl failed: curl: (28) Operation timed out after 20007 milliseconds with 0 bytes received
