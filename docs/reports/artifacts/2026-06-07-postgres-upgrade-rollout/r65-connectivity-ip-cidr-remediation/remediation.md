...
- Run ID: `r65-connectivity-ip-cidr-remediation-20260617`
- State: `blocked`
...
- Current route looks like the wide TUN catch-all range `32.0.0.0/3` is still winning over the host-specific rule. Route detail: `destination: 32.0.0.0        mask: 224.0.0.0     gateway: 198.18.0.1   interface: utun1024`.
