...
RUN_ID="${RUN_ID:-w2-client-cloudflare-baseline-$(date +%Y%m%d-%H%M%S)}"
ARTIFACT_DIR="${ARTIFACT_DIR:-$(pwd)/docs/reports/artifacts/2026-06-03-w2-client-cloudflare-baseline}"
