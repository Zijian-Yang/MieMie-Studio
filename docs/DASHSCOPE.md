...
| `qwen-image-2.0-pro` | HTTP 同步 | 文生图+图像编辑融合，n=1-6，自由尺寸，文字渲染更强 |
| `qwen-image-2.0` | HTTP 同步 | 文生图+图像编辑融合加速版，n=1-6，自由尺寸 |

### 文生视频模型

| 模型 | 调用方式 | 特点 |
|------|----------|------|
| `wan2.6-t2v` | HTTP 异步 | 多镜头叙事、自动配音、720P/1080P、2-15秒连续时长 |
| `wan2.5-t2v-preview` | SDK 异步 | 自动配音、480P/720P/1080P、5/10秒 |
| `wan2.2-t2v-plus` | HTTP 异步 | 无声视频、480P/1080P、固定5秒 |
| `wanx2.1-t2v-turbo` | SDK 异步 | 无声视频、480P/720P、固定5秒 |

### 图生视频模型

| 模型 | 调用方式 | 特点 |
|------|----------|------|
| `wan2.6-i2v` | HTTP 异步 | 720P/1080P、2-15秒连续时长、镜头类型、audio toggle |
| `wan2.6-i2v-flash` | HTTP 异步 | 极速版、720P/1080P、2-5秒连续时长、audio toggle |
| `wan2.5-i2v-preview` | SDK 异步 | 基础图生视频 |
| `wanx2.1-i2v-preview` | SDK 异步 | 快速生成 |
| `wan2.2-s2v` | HTTP 异步 | 数字人：图片+音频生成说话/唱歌视频 |

### 参考生视频模型

| 模型 | 调用方式 | 特点 |
|------|----------|------|
| `wan2.6-r2v-flash` | HTTP 异步 | 极速版、有声/无声切换、多镜头叙事、720P/1080P、2-10秒 |
| `wan2.6-r2v` | HTTP 异步 | 参考视频角色/音色自动提取、720P/1080P、2-15秒 |
