...
- 性能治理入口：新增高频运行路径脱敏耗时日志与 `loadtest/k6/s4-mixed-query-generate.js`，用于“多人查询 + 少量提交”的小而美容量证据采集；2026-05-29 尝试执行公网反代后 S4 基线时被 SSH 入口阻塞，公网 health 仍正常，恢复 SSH 后继续补跑
- 当前已消除：
