#!/usr/bin/env python3
"""Backfill per-user project JSON files into PostgreSQL."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Backfill projects from JSON files into PostgreSQL."
    )
    ...
    parser.add_argument(
        ...
        default=str(
            REPO_ROOT
            / "docs/reports/artifacts/2026-06-07-postgres-upgrade-rollout/r14-projects-backfill-reconcile/projects_backfill.json"
        ),
    )
...
def main() -> int:
    ...
    try:
        summary = backfill_projects(args.data_root, repository_factory)
