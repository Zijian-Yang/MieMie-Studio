  ...
  return (
    <div className={`login-page ${themeClass}`}>
      ...
      <div className="login-card">
        <div className="login-logo">
          <div className="logo-icon">
            <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M50 42 L50 35" stroke="white" strokeWidth="3" strokeLinecap="round" />
              <path d="M43 54 L37 58" stroke="white" strokeWidth="3" strokeLinecap="round" />
        ...
        <Form form={form} name="login" onFinish={handleSubmit} size="large" className="login-form">
          <Form.Item
            name="username"
            rules={[
          ...
          >
            <Input prefix={<UserOutlined className="input-icon" />} placeholder="用户名" autoComplete="username" />
          </Form.Item>
          ...
          {isRegister && (
            <Form.Item
              name="display_name"
              rules={[{ max: 30, message: '显示名称最多30个字符' }]}
            >
              <Input prefix={<UserOutlined className="input-icon" />} placeholder="显示名称（选填）" />
            </Form.Item>
          )}
