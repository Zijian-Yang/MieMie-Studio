"""Reconcile JSON and PostgreSQL video studio task state."""
...
SAFE_COMPARE_FIELDS = ("project_id", "status", "updated_at", "submit_attempt_id")
...
def write_reconcile_reports(summary: dict, output_dir: str | Path) -> tuple[Path, Path]:
    ...
    json_path = output_path / "video_studio_tasks_reconcile.json"
    markdown_path = output_path / "video_studio_tasks_reconcile.md"
