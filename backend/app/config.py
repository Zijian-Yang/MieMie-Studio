...
IMAGE_MODELS = {
    "wan2.6-image": {
        ...
        "common_sizes": [
            {"width": 1280, "height": 1280, "label": "1280x1280 方形 1:1"},
            {"width": 1024, "height": 1024, "label": "1024x1024 方形 1:1"},
            {"width": 896, "height": 896, "label": "896x896 方形 1:1"},
            {"width": 1280, "height": 720, "label": "1280x720 横向 16:9"},
            {"width": 720, "height": 1280, "label": "720x1280 竖向 9:16"},
            {"width": 1152, "height": 896, "label": "1152x896 横向 4:3"},
            {"width": 896, "height": 1152, "label": "896x1152 竖向 3:4"},
            {"width": 1200, "height": 800, "label": "1200x800 横向 3:2"},
            {"width": 800, "height": 1200, "label": "800x1200 竖向 2:3"},
        ],
        # 图像尺寸限制
    ...
    "wan2.6-t2i": {
        ...
        "common_sizes": [
            {"width": 1280, "height": 1280, "label": "1280x1280 方形 1:1"},
            {"width": 1440, "height": 1440, "label": "1440x1440 方形 1:1"},
            {"width": 1712, "height": 960, "label": "1712x960 横向 16:9"},
            {"width": 960, "height": 1712, "label": "960x1712 竖向 9:16"},
            {"width": 1488, "height": 1104, "label": "1488x1104 横向 4:3"},
            {"width": 1104, "height": 1488, "label": "1104x1488 竖向 3:4"},
            {"width": 1440, "height": 1152, "label": "1440x1152 横向 5:4"},
            {"width": 1152, "height": 1440, "label": "1152x1440 竖向 4:5"},
        ]
    },
    "wan2.5-t2i-preview": {
        ...
        "common_sizes": [
            ...
            {"width": 1280, "height": 720, "label": "1280x720 横向 16:9"},
            {"width": 720, "height": 1280, "label": "720x1280 竖向 9:16"},
            {"width": 1024, "height": 768, "label": "1024x768 横向 4:3"},
            {"width": 768, "height": 1024, "label": "768x1024 竖向 3:4"},
            {"width": 1440, "height": 810, "label": "1440x810 横向 16:9"},
            {"width": 810, "height": 1440, "label": "810x1440 竖向 9:16"},
        ]
    }
}
...
IMAGE_EDIT_MODELS = {
    "wan2.5-i2i-preview": {
        ...
        "common_sizes": [
            ...
            {"width": 1280, "height": 720, "label": "1280x720 横向 16:9"},
            {"width": 720, "height": 1280, "label": "720x1280 竖向 9:16"},
            {"width": 1280, "height": 960, "label": "1280x960 横向 4:3"},
            {"width": 960, "height": 1280, "label": "960x1280 竖向 3:4"},
            {"width": 1200, "height": 800, "label": "1200x800 横向 3:2"},
            {"width": 800, "height": 1200, "label": "800x1200 竖向 2:3"},
            {"width": 1344, "height": 576, "label": "1344x576 横向 21:9"},
        ],
        "supports_prompt_extend": True,
        "supports_watermark": True,
        "supports_seed": True,
...
TEXT_TO_VIDEO_MODELS = {
    "wan2.6-t2v": {
        ...
        "resolutions_1080p": [
            {"value": "1920*1080", "label": "1920x1080 横向 16:9"},
            {"value": "1080*1920", "label": "1080x1920 竖向 9:16"},
            {"value": "1440*1440", "label": "1440x1440 方形 1:1"},
            {"value": "1632*1248", "label": "1632x1248 横向 4:3"},
    ...
    "wan2.5-t2v-preview": {
        ...
        # 480P档位
        "resolutions_480p": [
            {"value": "832*480", "label": "832x480 横向 16:9"},
            {"value": "480*832", "label": "480x832 竖向 9:16"},
            {"value": "624*624", "label": "624x624 方形 1:1"},
        ],
        # 720P档位
        "resolutions_720p": [
            {"value": "1280*720", "label": "1280x720 横向 16:9"},
...
class ConfigManager:
    ...
    def save(self, config: AppConfig) -> None:
        ...
        with self._lock:
            ...
            if save_config_primary(current_user_id, config):
                if json_archive_writes_enabled():
                    self._write_with_lock(config.model_dump())
                return

            self._write_with_lock(config.model_dump())
            shadow_save_config(current_user_id, config)
